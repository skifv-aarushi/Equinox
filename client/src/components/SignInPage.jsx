  ...
  return (
    ...
    <div className="si-root">
      <div className="si-card">
        ...
        <p className="si-sub">Continue to Equinox 2026 Registration</p>
        ...
        <button
          ...
          disabled={!isLoaded}
        >
          <svg className="si-google-icon" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <p className="si-note">
          Only <strong>@vitstudent.ac.in</strong> accounts are permitted.
        </p>
      </div>
    </div>
    </>
